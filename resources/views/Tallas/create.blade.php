       ...
       <div class="panel-body">
        ...
        {{csrf_field()}}
          ...
          <div class="form-group{{ $errors->has('talla') ? ' has-error' : '' }}" >
              ...
              <input type="text" class="form-control" id="talla" name="talla"  placeholder="Escriba la talla" value="{{ old('talla') }}" required autofocus pattern="[a-zA-Z0-9-ñÑáéíóúÁÉÍÓÚ\s]+">
              @if ($errors->has('talla'))
